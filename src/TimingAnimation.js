...
class TimingAnimation extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.rotateAnimContainer}>
                ...
                <View style={styles.fadeInFadeOutAnim}>
                ...
                <TouchableOpacity style={[styles.startStopButton, { marginTop: 10 }]} onPress={() => this.checkPassword()}>
                    <Text style={styles.startStopText}>Password Shake</Text>
                </TouchableOpacity>

                <View style={{ height: 40, borderWidth: 2, marginTop: 10, width: available_width, marginTop: 20 }}>
